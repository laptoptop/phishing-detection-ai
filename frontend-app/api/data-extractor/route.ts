...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('📄 Received text for extraction, length:', textContent?.length);
    ...
    // Call n8n workflow
    const n8nUrl = `${process.env.NEXT_PUBLIC_N8N_WEBHOOK_URL}/data-extractor`;
    ...
    console.log('📊 Fields extracted:', data.data?.statistics?.fieldsExtracted);
